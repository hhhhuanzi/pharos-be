...
var I18N = `{
  "zh_CN": {
    ...
    "Logs Explorer": "日志查询",
    "Log Export": "日志导出",
    "Traces Explorer": "链路查询",
    "Traces Dependencies": "链路拓扑",
    ...
    "AI Config - LLM Configs": "AI 配置 - 大模型",
    "AI Config - Skills": "AI 配置 - Skills",
    "Audit Log - View": "操作审计 - 查看",
  ...
  "zh_HK": {
    ...
    "Logs Explorer": "日誌查詢",
    "Log Export": "日誌匯出",
    "Traces Explorer": "鏈路查詢",
    "Traces Dependencies": "鏈路拓撲",
    "Index Pattern - View": "索引模式 - 查看",
    "Index Pattern - Add": "索引模式 - 新增",
    "Index Pattern - Modify": "索引模式 - 修改",
    "Index Pattern - Delete": "索引模式 - 删除",
  ...
  "ja_JP": {
    ...
    "Log Export": "ログエクスポート",
    "Traces Explorer": "トレース エクスプローラー",
    "Traces Dependencies": "トレーストポロジー",
    ...
    "AI Config - LLM Configs": "AI設定 - LLM",
    "AI Config - Skills": "AI設定 - Skills",
    "Audit Log - View": "操作監査 - 表示",
  ...
  "ru_RU": {
    ...
    "Log Export": "Экспорт логов",
    "Traces Explorer": "Поиск трейсов",
    "Traces Dependencies": "Топология трейсов",
    ...
    "AI Config - LLM Configs": "AI конфигурация - LLM",
    "AI Config - Skills": "AI конфигурация - Skills",
